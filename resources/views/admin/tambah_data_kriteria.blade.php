                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="card">
                                    <div class="card-body">
                                    <form action="/insertkriteria" method="POST">
                                        @csrf
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="bobot_kriteria" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
                                        <div class="mb-3">
                                            <label for="exampleInputEmail1" class="form-label">Atribut</label>
                                            <input type="text" name="atribut" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                        </div>
