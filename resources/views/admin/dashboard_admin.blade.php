                ...
                <div class="container-fluid mt-5">
                    <div class="row my-4">
                        <div class="col-md-5 text-center">
                            <img src="img\makanans.png" class="img-fluid rounded" alt="Deskripsi Gambar" style="width: 300px; height: 450px;">
                        </div>
                        <div class="col-md-7">
                            <h2>Sistem Pendukung Keputusan Rekomendasi Makanan bagi Penderita Diabetes Melitus dengan Komplikasi Gagal Ginjal Kronik menggunakan Metode SAW </h2>
                            <br>
                            <p style="text-align: justify;">Sistem ini dapat digunakan untuk memberikan panduan kepada penderita diabetes dengan komplikasi gagal ginjal kronik, serta masyarakat umum dalam memilih makanan yang sehat. 
                                ...
                                indeks glikemik yang rendah, yaitu di bawah 55, juga penting karena membantu mengontrol gula darah. 
                            </p>  
                        </div>
                    </div>
                </div>
