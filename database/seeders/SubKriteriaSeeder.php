...
class SubKriteriaSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('sub_kriterias')->insert([
            ['nama_kriteria' => 'Natrium', 'rentang_nilai' => '<200 mg', 'nilai' => '3'],
            ['nama_kriteria' => 'Natrium', 'rentang_nilai' => '200 - 400 mg', 'nilai' => '2'],
            ['nama_kriteria' => 'Natrium', 'rentang_nilai' => '>400 mg', 'nilai' => '1'],
            ['nama_kriteria' => 'Kalium', 'rentang_nilai' => '<100 mg', 'nilai' => '3'],
            ['nama_kriteria' => 'Kalium', 'rentang_nilai' => '100 - 200 mg', 'nilai' => '2'],
            ['nama_kriteria' => 'Kalium', 'rentang_nilai' => '>200 mg', 'nilai' => '1'],
            ...
            ['nama_kriteria' => 'Indeks Glikemik', 'rentang_nilai' => '<55 mg', 'nilai' => '3'],
            ['nama_kriteria' => 'Indeks Glikemik', 'rentang_nilai' => '55 - 70 mg', 'nilai' => '2'],
            ['nama_kriteria' => 'Indeks Glikemik', 'rentang_nilai' => '>70 mg', 'nilai' => '1'],
